            ...
            {isAuthed && (
              <div className="hidden md:flex items-center gap-1">
                ...
                >
                  Notifications
                  {unread > 0 && (
                    <span className="ml-1 inline-flex items-center justify-center text-xs font-medium rounded-full bg-red-600 text-white px-2 py-0.5">
                      {unread}
                    </span>
                  )}
                </NavLink>
      ...
      {isAuthed && open && (
        <div className="md:hidden border-t border-gray-700">
          <div className="space-y-1 px-4 py-3">
            {/* mobile links kept as before; add pill if desired */}
            {/* ... */}
          </div>
        </div>
      )}
